        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-6">
            {work.features.map((feature, index) => (
              <Card
                key={index}
                className="group text-card-foreground relative flex flex-col overflow-hidden rounded-lg border bg-white shadow-sm transition-all duration-300 hover:scale-110 hover:shadow-md"
              >
                <div
                ...
                <CardContent className="relative flex-grow p-6">
                  <div className="flex items-start gap-4">
                    <div
                      className="text-primary flex items-center justify-center rounded-lg border-2 border-stone-300 p-3 shadow-lg"
                      style={{
                        background: `url("https://avatar.vercel.sh/${feature.title}") no-repeat center center / cover`
                      }}
                    >
