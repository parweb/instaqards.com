        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-amber-300/40 via-white/40 to-amber-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-white shadow-2xl shadow-amber-500/50'
                      : 'border-amber-600 bg-amber-800 text-amber-200 hover:bg-amber-700'
                  )}
                >
                  {tab.icon}
                </div>
