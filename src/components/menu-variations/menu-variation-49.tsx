...
export const MenuVariation49: React.FC = () => {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 overflow-hidden md:hidden">
      <div className="relative bg-gradient-to-t from-cyan-400 via-purple-500 to-pink-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-cyan-300/40 via-white/40 to-cyan-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 text-white shadow-2xl shadow-cyan-500/50'
                      : 'border-cyan-600 bg-cyan-800 text-cyan-200 hover:bg-cyan-700'
                  )}
                >
                  {tab.icon}
                </div>
