        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-cyan-300/40 via-white/40 to-cyan-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 text-white shadow-2xl shadow-cyan-500/50 border-white'
                      : 'bg-cyan-800 text-cyan-200 border-cyan-600 hover:bg-cyan-700'
                  )}
                >
                  {tab.icon}
                </div>
