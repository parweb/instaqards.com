...
export const MenuVariation21: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden overflow-hidden">
      <div className="relative bg-gradient-to-t from-green-600 via-teal-500 to-blue-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-teal-300/40 via-white/40 to-teal-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 text-white shadow-2xl shadow-teal-500/50 border-white'
                      : 'bg-teal-800 text-teal-200 border-teal-600 hover:bg-teal-700'
                  )}
                >
                  {tab.icon}
                </div>
