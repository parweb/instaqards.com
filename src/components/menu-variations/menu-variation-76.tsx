    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      <div className="relative bg-gradient-to-r from-slate-100 via-white to-slate-100 p-1">
        <div className="bg-white/90 backdrop-blur-sm px-4 py-4 relative overflow-hidden">
          ...
          <div
            className={cn(
              'absolute bottom-2 h-12 transition-all duration-700 ease-out opacity-20',
            ...
            {tabs.map((tab, index) => (
              ...
              >
                ...
                >
                  <div
                    className={cn(
                      'w-12 h-12 flex items-center justify-center transition-all duration-500 transform relative',
