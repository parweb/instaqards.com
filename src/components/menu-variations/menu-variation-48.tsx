...
export const MenuVariation48: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden overflow-hidden">
      <div className="relative bg-gradient-to-t from-brown-600 via-orange-500 to-yellow-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-orange-300/40 via-white/40 to-orange-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 text-white shadow-2xl shadow-orange-500/50 border-white'
                      : 'bg-orange-800 text-orange-200 border-orange-600 hover:bg-orange-700'
                  )}
                >
                  {tab.icon}
                </div>
