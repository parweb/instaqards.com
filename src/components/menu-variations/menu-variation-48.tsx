...
export const MenuVariation48: React.FC = () => {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 overflow-hidden md:hidden">
      <div className="from-brown-600 relative bg-gradient-to-t via-orange-500 to-yellow-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-orange-300/40 via-white/40 to-orange-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 text-white shadow-2xl shadow-orange-500/50'
                      : 'border-orange-600 bg-orange-800 text-orange-200 hover:bg-orange-700'
                  )}
                >
                  {tab.icon}
                </div>
