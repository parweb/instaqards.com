        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-blue-300/40 via-white/40 to-blue-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 text-white shadow-2xl shadow-blue-500/50 border-white'
                      : 'bg-blue-800 text-blue-200 border-blue-600 hover:bg-blue-700'
                  )}
                >
                  {tab.icon}
                </div>
