...
export const MenuVariation16: React.FC = () => {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 overflow-hidden md:hidden">
      <div className="relative bg-gradient-to-t from-blue-900 via-purple-600 to-cyan-400">
        {/* Effets spéciaux */}
        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-blue-300/40 via-white/40 to-blue-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 text-white shadow-2xl shadow-blue-500/50'
                      : 'border-blue-600 bg-blue-800 text-blue-200 hover:bg-blue-700'
                  )}
                >
                  {tab.icon}
                </div>
