...
export const MenuVariation23: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden overflow-hidden">
      <div className="relative bg-gradient-to-t from-gray-900 via-purple-800 to-indigo-900">
        {/* Effets spéciaux */}
        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-gray-300/40 via-white/40 to-gray-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 text-white shadow-2xl shadow-gray-500/50 border-white'
