        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-indigo-300/40 via-white/40 to-indigo-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-indigo-400 via-indigo-500 to-indigo-600 text-white shadow-2xl shadow-indigo-500/50'
                      : 'border-indigo-600 bg-indigo-800 text-indigo-200 hover:bg-indigo-700'
                  )}
                >
                  {tab.icon}
                </div>
