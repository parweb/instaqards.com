...
export const MenuVariation35: React.FC = () => {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 overflow-hidden md:hidden">
      <div className="relative bg-gradient-to-t from-yellow-500 via-pink-500 to-purple-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-yellow-300/40 via-white/40 to-yellow-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-white shadow-2xl shadow-yellow-500/50'
                      : 'border-yellow-600 bg-yellow-800 text-yellow-200 hover:bg-yellow-700'
                  )}
                >
                  {tab.icon}
                </div>
