        ...
        <div className="relative px-4 py-4 bg-black/30 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 bg-gradient-to-r from-pink-300/40 via-white/40 to-pink-300/40 rounded-2xl animate-pulse blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 text-white shadow-2xl shadow-pink-500/50 border-white'
                      : 'bg-pink-800 text-pink-200 border-pink-600 hover:bg-pink-700'
                  )}
                >
                  {tab.icon}
                </div>
