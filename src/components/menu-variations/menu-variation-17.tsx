...
export const MenuVariation17: React.FC = () => {
  ...
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 overflow-hidden md:hidden">
      <div className="relative bg-gradient-to-t from-pink-500 via-purple-500 to-blue-500">
        {/* Effets spéciaux */}
        ...
        <div className="relative bg-black/30 px-4 py-4 backdrop-blur-sm">
          <div className="flex items-center justify-around">
            {tabs.map((tab, index) => (
              ...
              >
                {activeTab === index && (
                  <div className="absolute -inset-2 animate-pulse rounded-2xl bg-gradient-to-r from-pink-300/40 via-white/40 to-pink-300/40 blur-sm" />
                )}
                ...
                <div
                  className={cn(
                    ...
                    activeTab === index
                      ? 'border-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 text-white shadow-2xl shadow-pink-500/50'
                      : 'border-pink-600 bg-pink-800 text-pink-200 hover:bg-pink-700'
                  )}
                >
                  {tab.icon}
                </div>
