      ...
      <div className="flex flex-col overflow-hidden rounded-lg">
        <div className="border-t border-stone-200 p-4 dark:border-stone-700">
          <div className="flex items-center justify-between">
            <Link prefetch className="flex-1" href={`/site/${site.id}`}>
            ...
            >
              <ModalButton variant="ghost" size="icon" label={<LuCopy />}>
                <SiteDuplicateModal site={site} />
              </ModalButton>

              <Link prefetch href={`/site/${site.id}/settings`} className="">
                <LuCog />
              </Link>
          ...
          <Link prefetch href={`/site/${site.id}`}>
