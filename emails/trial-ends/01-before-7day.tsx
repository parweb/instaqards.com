...
Email : Rappel Fin d'Essai - J-7

  Timing : Jour 23.
  Objectif : Premier rappel formel, rappeler la valeur, introduire les offres payantes.
  Contenu Clé :
    "Votre essai gratuit de [Nom de l'application] se termine dans 7 jours !"
    Récapitulatif rapide des bénéfices clés ou de ce que l'utilisateur a accompli (si possible).
    Explication claire de ce qui se passe après l'essai (perte d'accès à certaines fonctionnalités / données ?).
    CTA Principal : Lien vers la page de tarification / mise à niveau ("Choisir votre plan").
    Mettre en avant le plan le plus populaire ou celui qui correspond le mieux à son usage (si possible).
    Lien vers une FAQ sur la facturation ou le support.
  Sujet : Plus que 7 jours pour profiter de votre essai [Nom de l'application] !
